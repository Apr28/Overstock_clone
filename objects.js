let prodArr = [
    {
      ...
      info: { reviews: 500, discount: 20, brand: " iNSPIRE Q", availability: true, style: 'Traditional' }
    },
    {
      ...
      info: { reviews: 200, discount: 40, brand: "The Gray Barn", availability: true, style: '  Casual ' }
    ...
    },
    {
      ...
      info: { reviews: 136, discount: 20, brand: "Simple Living", availability: true, style: 'Southwestern' }
    },
    {
      ...
      info: { reviews: 29, discount: 27, brand: " Furniture of America", availability: true, style: ' 3. Mid-Century Modern' }
    },
    {
      ...
      desc: "",
      info: { reviews: 200, discount: 5, brand: "Simple Living", availability: true, style: 'Southwestern' }
    },
    {
      ...
      info: { reviews: 300, discount: 20, brand: "Furniture of America", availability: true, style: 'Casualy' }
    },
    {
      ...
      info: { reviews: 250, discount: 20, brand: "Furniture of America", availability: true, style: 'Farm House' }
    },
    {
      ...
      info: { reviews: 300, discount: 5, brand: "Parrot Uncle", availability: true, style: 'Southwestern' }
    },
    {
    ...
    },
    {
      ...
      info: { reviews: 235, discount: 10, brand: "Waterford", availability: true, style: 'Modern & Contemporary' }
    },
    {
      ...
      info: { reviews: 100, discount: 10, brand: "Thor Kitchen", availability: true, style: ' 3. Mid-Century Modern' }
    },
    {
      ...
      img_url: "https://ak1.ostkcdn.com/images/products/is/images/direct/db390afb2024234ecb7d04c059bfc44672c2478a/NewAir-Premium-Built-in-Outdoor-Refrigerator-160-Can-Storage-Beverage-Cooler-Center-Fridge-for-Patio---Stainless-Steel.jpg?impolicy=medium",
      imgArr: [
      ...
      info: { reviews: 100, discount: 20, brand: "NewAir", availability: true, style: '' }
    },
    {
      ...
      info: { reviews: 250, discount: 30, brand: "Zline Kitchen ", availability: true, style: 'Modern & Contemporary' }
    },
    {
      ...
      info: { reviews: 270, discount: 10, brand: " Berlinger Haus", availability: true, style: 'Modern & Contemporary' }
    },
    {
      ...
      desc: "Each knife handle is formed from strong ABS with a 430SS Bolster. Balanced, comfortable to hold, and ergonomically easy to hold, these handles allow you to make precision cuts for longer while minimizing accumulating soreness or pain.",
      info: { reviews: 165, discount: 10, brand: "Deco LLC", availability: true, style: 'Modern & Contemporary' }
    },
    {
      ...
      info: { reviews: 150, discount: 10, brand: "DEDO LLC", availability: true, style: 'Modern & Contemporary' }
    },
    {
      ...
      info: { reviews: 100, discount: 30, brand: "Homcom", availability: true, style: 'Formal' }
    },
    {
      ...
      info: { reviews: 320, discount: 10, brand: "Homcom", availability: true, style: 'Modern & Contemporary' }
    },
    {
      ...
      info: { reviews: 200, discount: 20, brand: "Haden", availability: true, style: 'Formal' }
    },
    {
      name: "Professional 1.2 Cu.Ft. Microwave and Grill Oven",
      img_url: "https://ak1.ostkcdn.com/images/products/is/images/direct/cdbd1d1f6bbeb7024f2688357d87e2f4d3bb62ec/Professional-1.2-Cu.Ft.-Microwave-and-Grill-Oven.jpg?impolicy=medium",
      imgArr: [
     ...
     // GUIDE ====>
  /*
        img_url - One main image of the product
        imgArr - [add some HQ images related to the same product]
        desc - Description about the product in few words
        details - Description in long format text
                        ****
